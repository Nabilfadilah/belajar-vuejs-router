<!-- Tugas 8: Membuat komponen ProductSearch.vue -->
<!-- Tambahkan nama product-search pada routing komponen ProductSearch
Ubah programmatic routing di ProductSearch menggunakan name -->
